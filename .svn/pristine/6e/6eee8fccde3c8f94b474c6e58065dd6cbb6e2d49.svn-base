...
<html>
  ...
  <div class="nav-main">
	  <div class="nav-box">
		  <div class="nav">
		    <ul class="nav-ul">
		    	<li><a class="home"><span>首页</span></a></li>
		  ...
		  <div class="nav-slide">
		      ...
		      <div class="nav-slide-o">
		      	<ul>
		      		<li id="cityManage"><a><span>地市管理</span></a></li>
		      		<li id="personnelManage"><a><span>人员权限管理</span></a></li>
		      		<li id="systemBackup"><a><span>系统备份</span></a></li>
		      		<li id="dataRecovery"><a><span>数据恢复</span></a></li>
		      		<li id="operationRecord"><a><span>操作记录查询</span></a></li>
		      	</ul>
		      </div>
		      <div class="nav-slide-o">
		      	<ul>
		      		<li id="custInfoApproal"><a><span>客户信息审批</span></a></li>
		      		<li id="custLoanApproal"><a><span>客户贷款审批</span></a></li>
		      		<li id="custInfoInquiry"><a><span>客户信息查询</span></a></li>
		      		<li id="assign"><a><span>分配功能</span></a></li>
		      	</ul>
		      </div>
		      <div class="nav-slide-o">
		      	<ul>
