					...
					<div class="logo_box">
						...
						<form action="/login.action" method="post" id="from_log" class="">
							<div class="input_outer">
								...
								<input id="phone_num" name="phone_num" class="text" style="color: #FFFFFF !important" type="text" placeholder="请输入账户">
							</div>
							
							<div class="input_outer">
								<span class="us_uer"></span>
								<input id="password" name="password" class="text" style="color: #FFFFFF !important; z-index:100;" type="password" placeholder="请输入密码">
							</div>
